...
class Overload2 {
	//Пример перегрузки кострукторов
	int x;
	Overload2() {
...
class Summation {
	//Демонстрация создания одного объекта при помощи передачи конструкторую уже существующего объекта
	int sum;
...
class Pr012 {
	public static void main(String args[]) {
		...
		System.out.println("ob2 совпадает по объёму с ob3: " + ob2.sameV(ob3));
