class Pr003 {
	public static void main(String args[]) {
		...
		//Приведение результатов деления к типу double
		...
		System.out.println("Тип данных long имеет разрядность 64 бит");
		...
		//Использование символьного типа даныых
		char ch;
		ch = 'X';
		...
		int_var = 0xFF; //Шестнадцатиричный форрмат числа
		int int_var2 = 023; //Восьмиричный формат числа
		int int_var3 = 0b00001000; //Двоичный формат числа
		System.out.println("Значения: " + int_var + " " + int_var2 + " " + int_var3);
		
		//Управляющие последовательностир символов
